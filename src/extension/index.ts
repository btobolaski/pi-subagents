...
export default function registerSubagentExtension(pi: ExtensionAPI): void {
	...
	registerWaitTool(pi, state, {
		enabled: waitToolConfig.enabled,
		subscriptions: waitSubscriptionManager,
		defaultTimeoutMs: waitToolConfig.defaultTimeoutMs,
		hasPendingSupervisorRequest: supervisorChannel.hasPendingRequests,
	});
